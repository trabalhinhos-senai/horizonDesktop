...
public class TelaConfig extends javax.swing.JFrame {
    ...
    TbConfigSistema config = new TbConfigSistema();
    ...
    private void btnSalvarConfigActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarConfigActionPerformed
        ...
        try {
            ...
            if (cxtNomeConfig.getText().equalsIgnoreCase("")) {
                ...
                config.setNomeEmpConfig(cxtNomeConfig.getText());
                config.setEnderecoEmpConfig(cxtEnderecoConfig.getText());
                config.setNumEmpConfig(Integer.parseInt(cxtNumeroConfig.getText()));
                config.setBairroEmpConfig(cxtBairroConfig.getText());
                config.setCidadeEmpCliente(cxtCidadeConfig.getText());
                config.setTelefoneEmpCliente(cxtTelefoneConfig.getText());
                config.setEmailEmpCliente(cxtEmailConfig.getText());
                config.setIdEmpConfig(1);
    ...
    private void Preencher() {
        List<TbConfigSistema> config1 = confRep.listar();
        TbConfigSistema configSel = config1.get(0);

        cxtNomeConfig.setText(configSel.getNomeEmpConfig());
        cxtEnderecoConfig.setText(configSel.getEnderecoEmpConfig());
        cxtNumeroConfig.setText(configSel.getNumEmpConfig().toString());
        cxtBairroConfig.setText(configSel.getBairroEmpConfig());
        cxtCidadeConfig.setText(configSel.getCidadeEmpCliente());
        cxtTelefoneConfig.setText(configSel.getTelefoneEmpCliente());
        cxtEmailConfig.setText(configSel.getEmailEmpCliente());
        cxtIdConfig.setText(configSel.getIdEmpConfig().toString());
    }
